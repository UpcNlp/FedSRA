...
export HIP_VISIBLE_DEVICES=1 CUDA_VISIBLE_DEVICES=1
/public/home/dongshou/anaconda/envs/ct/bin/python -u ce_train.py --alpha 0.05 --K 10 --epochs 150 --out saved_models/ce_a0.05_k10_s42
